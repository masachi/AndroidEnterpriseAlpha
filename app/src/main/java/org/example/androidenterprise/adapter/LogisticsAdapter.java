...
public class LogisticsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.img = (ImageView) convertView.findViewById(R.id.logistics_lv_img);
            holder.line = (TextView) convertView.findViewById(R.id.logistics_lv_line);
            holder.info = (TextView) convertView.findViewById(R.id.logistics_tv_info);
            holder.date = (TextView) convertView.findViewById(R.id.logistics_tv_date);
