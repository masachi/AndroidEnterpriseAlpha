package org.example.androidenterprise.utils.com.lling.photopicker.utils;
...
import org.example.androidenterprise.utils.com.lling.photopicker.Application;
...
import org.example.androidenterprise.utils.com.lling.photopicker.utils.*;
import org.example.androidenterprise.utils.libcore.io.DiskLruCache;
...
public class ImageLoader {
    ...
    private void initDiskCache() {
        try {
            File cacheDir = org.example.androidenterprise.utils.com.lling.photopicker.utils.OtherUtils.getDiskCacheDir(Application.getContext(), "images");
            if (!cacheDir.exists()) {
                cacheDir.mkdirs();
            }
            mDiskLruCache = DiskLruCache.open(cacheDir, org.example.androidenterprise.utils.com.lling.photopicker.utils.OtherUtils.getAppVersion(Application.getContext()),
                    1, 15 * 1024 * 1024);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private Bitmap tryLoadFromDiskCache(String path) {
        Bitmap bitmap = null;
        try {
            String key = org.example.androidenterprise.utils.com.lling.photopicker.utils.OtherUtils.hashKeyForDisk(path);
